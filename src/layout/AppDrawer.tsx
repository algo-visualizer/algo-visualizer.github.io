...
import { BookOpen, X, Settings as SettingsIcon } from "lucide-react";
      ...
      >
        ...
        <div className="p-4 space-y-2">
          ...
          <button
            ...
            className="w-full flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium text-zinc-300 hover:text-zinc-100 hover:bg-zinc-800 transition-all duration-200 group"
          >
            <SettingsIcon className="w-5 h-5 text-zinc-400 group-hover:text-zinc-300 transition-colors" />
            <span>Settings</span>
          </button>
          <a
